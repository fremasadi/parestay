                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('pemilik.kost.edit', $kost) }}" class="btn btn-sm btn-icon btn-warning" title="Edit">
                                            <i class="bx bx-edit"></i>
                                        </a>
                                        <form action="{{ route('pemilik.kost.destroy', $kost) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus kost ini?')">
                                            @csrf
                                            @method('DELETE')
