        ...
        <div class="container mx-auto px-4 max-w-4xl">
            <div class="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <span
                        class="inline-block mt-4 px-4 py-2 rounded-full text-sm font-semibold {{ $pembayaran->getStatusBadgeClass() }}">
                    ...
                    <div class="space-y-3">
                        ...
                        @if ($pembayaran->booking->kamar)
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold">Kamar {{ $pembayaran->booking->kamar->nomor_kamar }}</span>
                            </div>
                        @endif
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold">{{ $pembayaran->booking->durasi }}
                                {{ $pembayaran->booking->durasi_type }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-b py-6 mb-6 space-y-4">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="font-bold text-2xl text-teal-600">Rp
                            {{ number_format($pembayaran->gross_amount, 0, ',', '.') }}</span>
                    </div>
                        ...
                        <div class="bg-blue-50 p-4 rounded-lg">
                            <div class="flex justify-between items-center">
                                ...
                                <div class="text-right">
                                    <div class="font-mono font-bold text-lg text-blue-600">{{ $pembayaran->va_number }}
                                    </div>
                    ...
                    @if ($pembayaran->settlement_time)
                        <div class="flex justify-between">
                            ...
                            <span
                                class="font-semibold text-green-600">{{ $pembayaran->settlement_time->format('d M Y H:i') }}</span>
                        </div>
                    @endif
                </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">
                                    <strong>Perhatian:</strong> Mohon selesaikan pembayaran dalam 24 jam. Pesanan akan
                                    otomatis dibatalkan jika tidak dibayar.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            ...
            function showNotification(message, type) {
                ...
                notification.className =
                    `fixed top-4 right-4 z-50 px-6 py-4 rounded-lg shadow-lg text-white ${colors[type] || 'bg-gray-500'} transform transition-all duration-300 translate-x-0`;
