                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="border rounded p-3">
                                ...
                                <div class="mt-3">
                                    <a href="{{ route('admin.kost.show', $review->kost) }}" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="border rounded p-3">
                                ...
                                <div class="mb-2">
                                    ...
                                    <span class="badge {{ $review->reviewer->status === 'aktif' ? 'bg-label-success' : 'bg-label-secondary' }}">
                                        {{ ucfirst($review->reviewer->status) }}
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="mt-4 text-end">
                        <form action="{{ route('admin.reviews.destroy', $review) }}" 
                            ...
                            <button type="submit" class="btn btn-danger">
                                <i class="bx bx-trash me-1"></i> Hapus Review
                            </button>
                        </form>
                    </div>
                </div>
