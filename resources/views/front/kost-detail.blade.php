    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 sticky top-24">
                ...
                @if($kost->pemilik->no_telepon)
                    <a href="tel:{{ $kost->pemilik->no_telepon }}" class="block w-full text-center px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 mb-2">
                        📞 Hubungi Pemilik
                    </a>
                @endif
                <a href="#" class="block w-full text-center px-4 py-2 btn-teal text-white rounded-lg font-semibold">
                    Booking Sekarang
                </a>
            </div>
        </div>
